        ...
        <main class="form-registration">
            ...
            <form action="/register" method="post">
                ...
                <div class="form-floating">
                    <input type="text" name="name" class="form-control rounded-top @error('name') is-invalid @enderror"  id="name" placeholder="Your name.." value="{{ old('name') }}" required>
                ...
                <div class="form-floating">
                    <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" id="username" placeholder="example123" value="{{ old('username') }}"  required>
            ...
            <div class="mt-2 text-muted text-center">
                Has already an account? <a href="/login"> Login</a>
            </div>
